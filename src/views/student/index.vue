<template>
  <div class="dashboard-container">
    <div>
      <el-select v-model="form.academy" @change="classsChange" placeholder="请选择学院">
        <el-option
      ...
      <el-select v-model="form.classs" @change="classsChange" placeholder="请选择班级">
        <el-option
      ...
      <el-button @click="findUser">确定</el-button>
    </div>
