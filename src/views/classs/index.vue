    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope" >
          <el-tag v-if="scope.row.renshu<40">{{scope.row.renshu}}</el-tag>
          <el-tag v-else-if="scope.row.renshu<50"type="success">{{scope.row.renshu}}</el-tag>
          <el-tag v-else-if="scope.row.renshu<60"type="info">{{scope.row.renshu}}</el-tag>
          <el-tag v-else-if="scope.row.renshu<70"type="warning">{{scope.row.renshu}}</el-tag>
          <el-tag v-else-if="scope.row.renshu<80"type="danger">{{scope.row.renshu}}</el-tag>
        </template>
      </el-table-column>
      <!--      列表添加项目
      -->
